...
@RequestMapping(value = "/centro-custo")
public interface Centro_CustoAPI extends BaseResourceAPI<CentroCustoEntity>  {
	
	@GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.OK)
	ResponseEntity<Page<CentroCustoEntity>> findAll(
	...
	@ResponseStatus(HttpStatus.OK)
	ResponseEntity<List<CentroCustoTabelaDTO>> findTabelaCentroCusto(
			@RequestParam(value=APIControllersUtils.DEFINITION_FIELD, defaultValue="")Long field);
