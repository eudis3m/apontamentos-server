...
public interface RecursosAPI extends BaseResourceAPI<RecursosEntity>  {

	@GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.OK)
	ResponseEntity<Page<RecursosEntity>> findAll(
	...
	@GetMapping(value="/nmrecursos/{nmrecursos}", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.OK)
	ResponseEntity<List<RecursosEntity>> findByNmrecursos(@PathVariable("mrecursos") String nmrecursos) throws Exception;
	
	
	@GetMapping(value="/tabela/", produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseStatus(HttpStatus.OK)
	ResponseEntity<List<RecursosTabelaDTO>> findTabelaRecursos(
